...
<body>
   ...
   <!-- <nav class="" id="nav_container">
         <div id="nav_body">
            ...
            <input type="text" id="input_search" placeholder="ê²ìì´ë¥¼ ìë ¥íì¸ì">
   ...
   <section id="delData">
    ...
    <div id="dataBox">
        ...
        <label><input type="text" class="dataInput dataInput3" placeholder="" value="772-245"><input type="button" class="dataBtn3" value="ê²ì"></label>
