...
<section id="join-form-main" class="account-container">
	<form action="enroll.me" method="post" id="joinForm" name="frm1" role="form" onSubmit="return validate();" >
		<p class="join-form-top">JOIN</p>
     	 <ul class="join-form-ul">
     	 	...
     	 	<li>
     	 		<input type="text" name="mem_tel" id="mem_tel" class="join-form-textarea" placeholder="휴대폰 번호" maxlength="13">
     	 	...
     	 	<li>
     	 		...
     	 		<input type="radio" value="남" id="gender_radio1" name="mem_gender" class="genderCheck"/>
     	 		<label class="gender-radio-label" id="gender1" for="gender_radio1"><p class="join-gender-p" name="mem_gender">남</p></label>
     	 		<input type="radio" value="여" id="gender_radio2" name="mem_gender" class="genderCheck"/>
     	 		<label class="gender-radio-label" id="gender2" for="gender_radio2"><p class="join-gender-p" name="mem_gender">여</p></label>
     	 	</li>
     	 	<li class="hidden_line_cl">
   ...
   function validate(){
	 	var submit_Arr = new Array(9).fill(false);
	...
	$('#mem_email').on('keyup',function(){
		if($('#mem_email').val()==''){
			...
			var mem_email=$('#mem_email').val(); 
				$.ajax({ 
					async : true, 
					data : {"mem_email":mem_email},  //mem_email 의 이름으로 mem_email 데이터를
