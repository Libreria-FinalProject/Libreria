...
<body>
   ...
   <section>
    ...
    <div class="faq_content">
        <p>마일리지는 구매 하실 때 마다 구매 금액의 1%가 적립 됩니다.</p>
        <p>마일리지를 모으셔서 책을 구매하시거나 대여 하시는 방법으로 사용이 가능하십니다.</p>
        <p>마일리지를 사용하고자 하실 때는 구매 및 대여시 결제 화면에 나타나는 마일리지 사용 체크칸에 꼭 체크를 하신 후 결제를 해 주시기 바랍니다.</p>
        <p>감사합니다.</p>
    </div>
